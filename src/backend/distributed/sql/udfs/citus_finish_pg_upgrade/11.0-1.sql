...
BEGIN
    ...
    -- we recreate citus_stat_activity after PG updates so it reflects the changes in pg_stat_activity
    #include "../../udfs/citus_stat_activity/11.0-1.sql"
    ALTER EXTENSION citus ADD VIEW citus_stat_activity;
    ALTER EXTENSION citus ADD TYPE citus_stat_activity_one_node;
END;
$cppu$;
